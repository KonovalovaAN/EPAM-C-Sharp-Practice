namespace Literals
{
    public static class LongIntegers
    {
        ...
        {
            return 0b1011011010100100101000001010101110111010011110000111010010101L;
        }

        public static long ReturnLongInteger211()
        {
            return 0b101010101010101010101010101010101010101010101010101010101010101L;
        }
