    ...
    public static class Translator
    {
        ...
        public static void WriteMorse(char[][] codeTable, string message, StringBuilder morseMessageBuilder, char dot = '.', char dash = '-', char separator = ' ')
        {
            ...
            for (int i = 0; i < message.Length; i++)
            {
                ...
                if (i != 0)
                {
#pragma warning disable CA1834 // Рекомендация использовать метод "StringBuilder.Append(char)" по мере возможности
                    morseMessageBuilder.Append(" ");
#pragma warning restore CA1834 // Рекомендация использовать метод "StringBuilder.Append(char)" по мере возможности
                }
