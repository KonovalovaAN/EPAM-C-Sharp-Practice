...
#pragma warning restore IDE0057 // Использовать оператор диапазона
        ...
        {
#pragma warning disable CA2249 // Попробуйте использовать "string.Contains" вместо "string.IndexOf"
            return "aeiou".IndexOf(c, StringComparison.CurrentCultureIgnoreCase) >= 0;
#pragma warning restore CA2249 // Попробуйте использовать "string.Contains" вместо "string.IndexOf"
        }
    }
}
